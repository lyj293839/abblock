...
<div class="User_ship">
    <br>
    <div class="heard">
        <el-button type="primary" icon="el-icon-plus" size="small"  @click="click_formAddress('Add Billing Address')">Add Billing Address</el-button>
    </div>
    <div class="List" v-for="(item,index) in List" :key="index" :style="index%2?'background:#f8f8f7;':''">
        ...
        <div>
            ...
            <el-button type="primary" icon="el-icon-edit" size="mini" @click="click_formAddress('Edit Billing Address',{name:1})">Edit</el-button>
